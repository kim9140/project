...
public class KneeActivity extends YouTubeBaseActivity {
    //객체 선언
    ...
    private static String videoId = "5AKj09I9GoE";
    //"C7v5wvKd6Dk";

    //logcat 사용 설정
    private static final String TAG = "KneeActivity";

    //유튜브 플레이어 메서드
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.kneestretching_layout);
        initPlayer();
        Button btnPlay = findViewById(R.id.knee_playerBtn);
    ...
    private void initPlayer() {
        playerView = findViewById(R.id.knee_youtube);
