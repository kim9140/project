...
public class NeckActivity extends YouTubeBaseActivity {
    //객체 선언
    ...
    private static String videoId = "v5RcDJHJm04";
    //logcat 사용 설정
    private static final String TAG = "NeckActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.neckstretching_layout);
        initPlayer();
        Button btnPlay = findViewById(R.id.neck_playerBtn);
    ...
    private void initPlayer() {
        playerView = findViewById(R.id.neck_youtube);
