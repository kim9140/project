...
public class LegActivity  extends YouTubeBaseActivity {
    //객체 선언
    ...
    private static String videoId = "NABkYV6IWYA";

    //logcat 사용 설정
    private static final String TAG = "LegActivity";

    //유튜브 플레이어 메서드
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.legstretching_layout);
        initPlayer();
        Button btnPlay = findViewById(R.id.leg_playerBtn);
    ...
    private void initPlayer() {
        playerView = findViewById(R.id.leg_youtube);
