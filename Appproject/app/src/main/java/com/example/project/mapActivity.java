...
public class mapActivity extends AppCompatActivity implements OnMapReadyCallback, ActivityCompat.OnRequestPermissionsResultCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://map.naver.com/v5/directions"));
    ...
    private void startLocationUpdates() {
        ...
        if (!checkLocationServicesStatus()) {
            ...
            if (hasFineLocationPermission != PackageManager.PERMISSION_GRANTED ||
                ...
                Log.d(TAG, "startLocationUpdates : 퍼미션을 갖고있지 않습니다");
                return;
            }
    ...
    public void setDefaultLocation() {
        ...
        String markerTitle = "위치정보 가져올 수 없습니다";
