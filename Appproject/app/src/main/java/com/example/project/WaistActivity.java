...
public class WaistActivity extends YouTubeBaseActivity {
    //객체 선언
    ...
    private static String videoId = "W6_nE9BXuTs";
    //logcat 사용 설정
    private static final String TAG = "WaistActiviy";

    //유튜브 플레이어 메서드
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.waiststretching_layout);
        initPlayer();
        Button btnPlay = findViewById(R.id.waist_playerBtn1);
    ...
    private void initPlayer() {
        playerView = findViewById(R.id.waist_youtube1);
