...
public class ArmActivity extends YouTubeBaseActivity {
    //객체 선언
    ...
    private static String videoId = "h2Tm7z1cXcA";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.armstretching_layout);
        initPlayer();
        Button btnPlay = findViewById(R.id.arm_playerBtn);
    ...
    private void initPlayer() {
        playerView = findViewById(R.id.arm_youtube);
